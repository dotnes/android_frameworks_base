...
public class ToggleHoloBamTile extends QuickSettingsTile {

    public ToggleHoloBamTile(Context context,
            QuickSettingsController qsc, Handler handler) {
        super(context, qsc);

        mLabel = context.getString(R.string.quick_settings_holobam_label);
    ...
    private synchronized void updateTile() {
        if(getUiInvertedMode()){
            ...
            mLabel = mContext.getString(R.string.quick_settings_holobam_on_label);
        }else{
            mDrawable = R.drawable.ic_qs_jb_dark_off;
            mLabel = mContext.getString(R.string.quick_settings_holobam_off_label);
        }
    }
